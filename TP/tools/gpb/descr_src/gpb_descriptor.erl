...
-export_type(['UninterpretedOption.NamePart'/0, 'UninterpretedOption'/0, 'MethodOptions'/0, 'OneofDescriptorProto'/0, 'SourceCodeInfo.Location'/0, 'SourceCodeInfo'/0, 'FileOptions'/0, 'FieldOptions'/0, 'FieldDescriptorProto'/0, 'ServiceOptions'/0, 'MethodDescriptorProto'/0, 'ServiceDescriptorProto'/0, 'EnumOptions'/0, 'EnumValueOptions'/0, 'EnumValueDescriptorProto'/0, 'EnumDescriptorProto'/0, 'DescriptorProto.ReservedRange'/0, 'MessageOptions'/0, 'DescriptorProto.ExtensionRange'/0, 'DescriptorProto'/0, 'FileDescriptorProto'/0, 'FileDescriptorSet'/0, 'GeneratedCodeInfo.Annotation'/0, 'GeneratedCodeInfo'/0]).

-spec encode_msg(#'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'MethodOptions'{} | #'OneofDescriptorProto'{} | #'SourceCodeInfo.Location'{} | #'SourceCodeInfo'{} | #'FileOptions'{} | #'FieldOptions'{} | #'FieldDescriptorProto'{} | #'ServiceOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'EnumOptions'{} | #'EnumValueOptions'{} | #'EnumValueDescriptorProto'{} | #'EnumDescriptorProto'{} | #'DescriptorProto.ReservedRange'{} | #'MessageOptions'{} | #'DescriptorProto.ExtensionRange'{} | #'DescriptorProto'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{} | #'GeneratedCodeInfo.Annotation'{} | #'GeneratedCodeInfo'{}) -> binary().
...
get_msg_names() ->
    ['UninterpretedOption.NamePart', 'UninterpretedOption',
     'MethodOptions', 'OneofDescriptorProto',
     ...
     'EnumDescriptorProto', 'DescriptorProto.ReservedRange',
     'MessageOptions', 'DescriptorProto.ExtensionRange',
     'DescriptorProto', 'FileDescriptorProto',
     'FileDescriptorSet', 'GeneratedCodeInfo.Annotation',
     'GeneratedCodeInfo'].
